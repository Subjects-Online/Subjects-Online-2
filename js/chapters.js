...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const chapters = (typeof getSubjectSectionData === 'function')
        ? getSubjectSectionData(subject, 'chapters')
        : ((subject.content && subject.content.chapters) ? subject.content.chapters : defaultChapters);
            ...
            <div class="lecture-item ${isPdf ? 'is-pdf' : 'is-video'} ${isDone ? 'done' : ''}" ${clickHandler}>
                <div class="lec-info">
                    ...
                    <div class="lec-text-col">
                        ...
                        ` : `
                        <a href="player.html?id=${lec.id}&subjectId=${subjectId}&type=${lec.type}&url=${encodeURIComponent(lec.url)}&title=${encodeURIComponent(lec.title)}&sec=chapters${nextParams}" class="lec-open-btn" onclick="event.stopPropagation()">
                            Open
