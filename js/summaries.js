    ...
    const defaultChapters = [
        {
            ...
            lectures: [
                { id: 101, title: "Summary 1: Basics", type: "pdf", url: "materials/dummy.pdf" },
                { id: 102, title: "Summary 2: Core Concepts", type: "pdf", url: "materials/dummy.pdf" }
            ]
        }
    ];

    // Load chapters for the specific subject, or fallback to default
    const chapters = (subject.content && subject.content.summaries && subject.content.summaries.length > 0) ? subject.content.summaries : defaultChapters;
