...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.documentElement.style.setProperty('--subject-accent', '#10b981'); // Sky Blue 500
    document.documentElement.style.setProperty('--subject-glow', '#6ee7b7');   // Sky Blue 300
    ...
    globalBg.style.background = `radial-gradient(circle at 80% 10%, rgba(52, 211, 153, 0.15) 0%, transparent 50%), radial-gradient(circle at 20% 80%, rgba(16, 185, 129, 0.1) 0%, transparent 50%), linear-gradient(135deg, #ffffff 0%, #ecfdf5 100%)`;
    ...
    gridTexture.style.backgroundImage = 'linear-gradient(rgba(16, 185, 129, 0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(16, 185, 129, 0.03) 1px, transparent 1px)';
            ...
            <div class="chap-main-content">
                <div class="chap-header">
                    <div class="chap-header-left">
                        ...
                        <h2 class="chap-title-text group-hover:text-emerald-700 transition-colors">${ch.title}</h2>
                    </div>
                    <div class="chap-toggle-icon group-hover:bg-emerald-100 group-hover:text-emerald-700 transition-colors shadow-sm">
